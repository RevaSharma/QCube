...
public class CheckExistingDBFrame extends javax.swing.JFrame implements ActionListener{
    ...
    private JRadioButton allQ;
    private JLabel checkQ;
    ...
    public CheckExistingDBFrame() {
        ...
        mainTitleUnderline.setText("________________________________________________________");
        ...
        mainTitleUnderline2.setText("________________________________________");
        ...
        writeMarks.setBounds(500, 490, 150, 60);
        Font writeMarksFont=new Font("Times New Roman", Font.BOLD, 27);
        writeMarks.setFont(writeMarksFont);
        
        allQ=new JRadioButton("If you would like to see the entire database, then select this");
        allQ.setBounds(70, 580, 1000, 60);
        Font allQFont=new Font("Times New Roman", Font.BOLD, 27);
        allQ.setFont(allQFont);
        
        checkQ=new JLabel();
        checkQ.setBounds(70, 620, 1000, 60);
        checkQ.setText("    (All your filters will be ignored)");
        Font checkQFont=new Font("Times New Roman", Font.BOLD, 27);
        checkQ.setFont(checkQFont);
       
        check=new JButton();
        check.setBounds(50, 700, 250, 60);
        check.setText("Check");
        Font checkFont=new Font("Times New Roman", Font.BOLD, 27);
 ...
 @Override
    public void actionPerformed(ActionEvent e) {
        ...
        String level;
              ...
              cedf2.allQuestionData(level, paperType, subChoice, tpChoice,marksNo);
        ...
        String level;
              ...
              String subChoice=(String)subChoices.getSelectedItem();
              String marksNo=(String)writeMarks.getText();
              cedf2.fetchDataWithAll(level,paperType,subChoice,tpChoice,marksNo);
        }
        }
